  ...
  return (
    <>
      <Container ref={containerEl} isSticky={isSticky} isDesktop={isDesktop}>
        <Top>
          <Column>
            <Small>
              ...
              alamat : Jl. Paradise Rasamala 3 No.3 blok i10/15C, Babakan
            </Small>
            <Small>
        ...
        <Bottom>
          <LogoContainer to="/">
            <img src="/assets/logo.png" alt="Diglaw Logo" style={{ height: "80px", width:"130px" }} />
          </LogoContainer>
          <Right toggle={navToggle}>
            ...
            <MediaContainer>
              <MediaIconContainer 
                as="a"  href={`https://www.instagram.com/laukku.ikan/`} target="_BLANK">
